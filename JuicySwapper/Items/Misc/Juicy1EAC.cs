...
{
    public partial class Juicy1EAC : Form
    {
        bool enabled = Settings.Default.JuicyEAC1Enabled;
        SwapUtilities SwapUtilities = new SwapUtilities();
        string placeholder = "Juciy EAC";
        ...
        private void ConvertBytes_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            bool Swap1 = JuicyUtilities.DownloadConvert("Juicy1");
            if (Swap1)
            {
        ...
        {
            SkinImage.Image = Resources.Juicy1;
        }
