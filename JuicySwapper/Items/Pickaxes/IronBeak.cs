...
namespace JuicySwapper.Items.Pickaxes
{
    ...
    {
        bool enabled = Settings.Default.IronBeakEnabled;
        SwapUtilities SwapUtilities = new SwapUtilities();
        string placeholder = "Iron Beak";
        ...
        string SwapOffset = "?WID_Hrvest_Pickaxe_RavenQuill";
        string Mat = "WMaterils/MIs";
        string Mat1 = "WMaterils/Mka";
        ...
        private void ConvertBytes_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (Swap1)
            {
                Settings.Default.IronBeakEnabled = true;
        ...
        private void RevertBytes_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (Swap1)
            {
                Settings.Default.IronBeakEnabled = false;
                Settings.Default.Save();
                LogBox.Text += "\n[LOG] Mat removed";
            }
