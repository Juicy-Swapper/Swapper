...
namespace JuicySwapper.Items.Skins
{
    ...
    {
        bool enabled = Settings.Default.ReconSpecialistEnabled;
        SwapUtilities SwapUtilities = new SwapUtilities();
        string placeholder = "Recon Specialist";
