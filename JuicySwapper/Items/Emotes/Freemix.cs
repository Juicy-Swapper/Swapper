...
{
    public partial class Freemix : Form
    {
        bool enabled = Settings.Default.FreemixEnabled;
        SwapUtilities SwapUtilities = new SwapUtilities();
        string placeholder = "Free mix";
        ...
        private void ConvertBytes_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (Swap1)
            {
                Settings.Default.FreemixEnabled = true;
        ...
        private void RevertBytes_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            if (Swap1)
            {
                Settings.Default.FreemixEnabled = false;
                Settings.Default.Save();
                LogBox.Text += "\n[LOG] Emote removed";
            }
